...
fn fragment(
    ...
    let dots = step(0.4, fract((angle - globals.time * 0.5) * 8.0 / 3.14159));
    ...
    let segments = step(0.2, fract((angle + globals.time * 1.5) * 3.0 / 3.14159));
    ...
    let ticks = step(0.82, fract((angle + globals.time * 0.7) * 16.0 / 3.14159));
    ...
    let pulse = 1.0 + 0.15 * sin(globals.time * 8.0);
